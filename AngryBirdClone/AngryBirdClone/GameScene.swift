...
class GameScene: SKScene, SKPhysicsContactDelegate{
    ...
    override func didMove(to view: SKView) {
        ...
        bird2.size = CGSize(width: self.frame.width / 14 , height: self.frame.width / 14)
        bird2.zPosition = 1
        self.addChild(bird2)
         */
        ...
        bird.physicsBody?.mass = 0.15 // kusun kilosu
        ...
        box1.physicsBody?.allowsRotation = true //sağa sola dönebilir mi?
        ...
        box2.physicsBody?.allowsRotation = true //sağa sola dönebilir mi?
        ...
        box3.physicsBody?.allowsRotation = true //sağa sola dönebilir mi?
        ...
        box4.physicsBody?.allowsRotation = true //sağa sola dönebilir mi?
        ...
        box5.physicsBody?.allowsRotation = true //sağa sola dönebilir mi?
